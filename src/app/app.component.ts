...
export class AppComponent {
  ...
  constructor(private movieApiService: MovieApiService) { // Pide el servicio mediante inyección de dependencias, es decir, busca quien está registrado
  }

  loadMovies = async() => { // Método asincrono (ejecucion rápida y carga rápida de datos) que llama al método getAll() (contiene las peliculas) del servicio movie-api y los almacena en la variable local "movies"
